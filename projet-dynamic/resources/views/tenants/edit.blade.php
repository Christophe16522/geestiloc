@extends('layouts.app')
@section('title', 'Modifier — ' . $tenant->full_name)
@section('content')

<div class="d-flex align-items-center gap-2 mb-4">
    <a href="{{ route('tenants.show', $tenant) }}" class="btn btn-sm btn-outline-secondary"><i class="fas fa-arrow-left"></i></a>
    <h1 class="mb-0" style="font-size:1.5rem;font-weight:800;">Modifier — {{ $tenant->full_name }}</h1>
</div>
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <select name="property_id" class="form-select @error('property_id') is-invalid @enderror">
                            ...
                            <option value="{{ $property->id }}" @selected(old('property_id', $tenant->property_id)==$property->id)>
